...
import ml.wolfe.mln.MLNParser._
...
import ml.wolfe.mln.MLNParser.IntegerTypeDefinition
import ml.wolfe.mln.MLNParser.Atom
import ml.wolfe.mln.MLNParser.HardFormula
import ml.wolfe.legacy.value.RangeSet
import ml.wolfe.mln.MLNParser.AsteriskFormula
import ml.wolfe.mln.MLNParser.AsteriskAtom
import ml.wolfe.mln.MLNParser.WeightedFormula
import ml.wolfe.mln.MLNParser.And
import ml.wolfe.mln.MLNParser.DatabaseAtom
import ml.wolfe.mln.MLNParser.ConstantTypeDefinition
import ml.wolfe.legacy.term.Predicate
import ml.wolfe.mln.MLNParser.Equivalence
import ml.wolfe.mln.MLNParser.PlusVariable
import ml.wolfe.mln.MLNParser.Or
import ml.wolfe.legacy.term.LambdaAbstraction
import ml.wolfe.mln.MLNParser.PlusAtom
import ml.wolfe.legacy.term.Var
import ml.wolfe.mln.MLNParser.Not
import ml.wolfe.legacy.term.TupleTerm2
import ml.wolfe.legacy.term.CartesianProductTerm2
import ml.wolfe.mln.MLNParser.ExclamationVariable
import ml.wolfe.mln.MLNParser.VariableOrType
import ml.wolfe.legacy.term.FunApp
import ml.wolfe.mln.MLNParser.FunctionDefinition
import ml.wolfe.mln.MLNParser.Implies
