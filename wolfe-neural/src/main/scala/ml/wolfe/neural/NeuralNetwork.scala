...
//  }
  ...
  def backprop(input: DenseMatrix[Double], outputs: DenseVector[Double], loss: NeuralLossFunction, updateWeights: Boolean = true, iters: Int = 1, rate: Double = 0.9, verbose: Boolean = false) = {
